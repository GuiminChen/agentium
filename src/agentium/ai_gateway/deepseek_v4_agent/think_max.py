"""Table 3 verbatim system augmentation for Think Max-style reasoning (DeepSeek-V4 report)."""

THINK_MAX_SYSTEM_INSTRUCTION = """Reasoning Effort: Absolute maximum with no shortcuts permitted.
